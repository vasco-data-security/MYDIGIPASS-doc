...
The openid LoA parameter can also be specified in this request, passing
the requested value (one of "http://eidas.europa.eu/LoA/high", "http://eidas.europa.eu/LoA/substantial" or "http://eidas.europa.eu/LoA/low") to the key "acr_values".
Requiring "http://eidas.europa.eu/LoA/high" will prevent users from authenticating with an SMS code.
...
jti   | A unique identifier, generated by you, that will invalidate any reuse of this client_assertion
